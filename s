...
DDEESSCCRRIIPPTTIIOONN
       ...
       Since version 3.0.0, pacman has been the front-end to lliibbaallppmm(3), the "Arch Linux Package
       ...
       operate on. A _t_a_r_g_e_t is usually a package name, file name, URL, or a search string. Targets
...
OOPPEERRAATTIIOONNSS
       ...
       --RR,, ----rreemmoovvee
           ...
           be saved with a _._p_a_c_s_a_v_e extension unless the _-_-_n_o_s_a_v_e option is used. See Remove Options
           below.
       ...
       --SS,, ----ssyynncc
           ...
           Additionally, version strings can have an _e_p_o_c_h value defined that will overrule any
...
OOPPTTIIOONNSS
       --bb,, ----ddbbppaatthh <path>
           ...
           not be used unless you know what you are doing.  NNOOTTEE: If specified, this is an absolute
       ...
       --rr,, ----rroooott <path>
           ...
           to install software into /usr/local instead of /usr.  NNOOTTEE: If database path or log file
           are not specified on either the command line or in ppaaccmmaann..ccoonnff(5), their default location
           will be inside this root path.  NNOOTTEE: This option is not suitable for performing
           operations on a mounted guest system. See _-_-_s_y_s_r_o_o_t instead.
       ...
       ----ccaacchheeddiirr <dir>
           ...
           passed to pacman.  NNOOTTEE: This is an absolute path, and the root path is not automatically
           prepended.

       ----ccoolloorr <when>
           Specify when to enable coloring. Valid options are _a_l_w_a_y_s, _n_e_v_e_r, or _a_u_t_o.  _a_l_w_a_y_s forces
           colors on; _n_e_v_e_r forces colors off; and _a_u_t_o only automatically enables colors when
       ...
       ----ggppggddiirr <dir>
           ...
           so-called trust database, which specifies that the keys are authentic and trusted.  NNOOTTEE:
       ...
       ----hhooookkddiirr <dir>
           ...
           directories taking precedence over hooks in earlier directories.  NNOOTTEE: This is an
       ...
       ----ddiissaabbllee--ddoowwnnllooaadd--ttiimmeeoouutt
...
TTRRAANNSSAACCTTIIOONN OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --SS,, --RR AANNDD --UU))
       ...
       ----aassssuummee--iinnssttaalllleedd <package=version>
           ...
           dependency checks. To disable all dependency checking, see the _-_-_n_o_d_e_p_s option.
       ...
       --pp,, ----pprriinntt
           ...
           upgrade). Use _-_-_p_r_i_n_t_-_f_o_r_m_a_t to specify how targets are displayed. The default format
           string is "%l", which displays URLs with _-_S, file names with _-_U, and pkgname-pkgver with
           _-_R.

       ----pprriinntt--ffoorrmmaatt <format>
           Specify a printf-like format to control the output of the _-_-_p_r_i_n_t operation. The possible
           attributes are: "%n" for pkgname, "%v" for pkgver, "%l" for location, "%r" for
           repository, and "%s" for size. Implies _-_-_p_r_i_n_t.
...
UUPPGGRRAADDEE OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --SS AANNDD --UU))
       ...
       ----aasseexxpplliicciitt
           ...
           will not be removed by the _-_-_r_e_c_u_r_s_i_v_e remove operation.
       ...
       ----iiggnnoorreeggrroouupp <group>
           Directs pacman to ignore upgrades of all packages in _g_r_o_u_p, even if there is one
           available. Multiple groups can be specified by separating them with a comma.

       ----nneeeeddeedd
           Do not reinstall the targets that are already up-to-date.

       ----oovveerrwwrriittee <glob>
           Bypass file conflict checks and overwrite conflicting files. If the package that is about
           to be installed contains files that are already installed and match _g_l_o_b, this option
           will cause all those files to be overwritten. Using _-_-_o_v_e_r_w_r_i_t_e will not allow
...
QQUUEERRYY OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --QQ))
       ...
       --dd,, ----ddeeppss
           ...
           combined with _-_t for listing real orphans - packages that were installed as dependencies
       ...
       --ee,, ----eexxpplliicciitt
           ...
           with _-_t to list explicitly installed packages that are not required by any other package.
       ...
       --ii,, ----iinnffoo
           Display information on a given package. The _-_p option can be used if querying a package
           file instead of the local database. Passing two _-_-_i_n_f_o or _-_i flags will also display the
       ...
       --mm,, ----ffoorreeiiggnn
           ...
           Typically these are packages that were downloaded manually and installed with _-_-_u_p_g_r_a_d_e.

       --nn,, ----nnaattiivvee
           Restrict or filter output to packages that are found in the sync database(s). This is the
           inverse filter of _-_-_f_o_r_e_i_g_n.
       ...
       --pp,, ----ffiillee
           ...
           _-_-_i_n_f_o and _-_-_l_i_s_t.
       ...
       --uu,, ----uuppggrraaddeess
           ...
           This option works best if the sync database is refreshed using _-_S_y.

RREEMMOOVVEE OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --RR))
       ...
       --nn,, ----nnoossaavvee
           ...
           _._p_a_c_s_a_v_e extension.
       ...
       --ss,, ----rreeccuurrssiivvee
           ...
           user. This operation is recursive and analogous to a backwards _-_-_s_y_n_c operation, and it
       ...
       --uu,, ----uunnnneeeeddeedd
           ...
           removing a group without using the _-_c option, to avoid breaking any dependencies.

SSYYNNCC OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --SS))
       --cc,, ----cclleeaann
           ...
           are not deleted even if they are removed from the configuration file ppaaccmmaann..ccoonnff(5). Use
           one _-_-_c_l_e_a_n switch to only remove packages that are no longer installed; use two to
           remove all files from the cache. In both cases, you will have a yes or no option to
           remove packages and/or unused downloaded databases.

           If you use a network shared cache, see the _C_l_e_a_n_M_e_t_h_o_d option in ppaaccmmaann..ccoonnff(5).
       ...
       --ii,, ----iinnffoo
           Display information on a given sync database package. Passing two _-_-_i_n_f_o or _-_i flags will
       ...
       --uu,, ----ssyyssuuppggrraaddee
           ...
           Additional targets can also be specified manually, so that _-_S_u _f_o_o will do a system
       ...
       --yy,, ----rreeffrreesshh
           ...
           ppaaccmmaann..ccoonnff(5). This should typically be used each time you use _-_-_s_y_s_u_p_g_r_a_d_e or _-_u.
           Passing two _-_-_r_e_f_r_e_s_h or _-_y flags will force a refresh of all package databases, even if
           they appear to be up-to-date.

DDAATTAABBAASSEE OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --DD))
...
FFIILLEE OOPPTTIIOONNSS ((AAPPPPLLYY TTOO --FF))
       --yy,, ----rreeffrreesshh
       ...
       --qq,, ----qquuiieett
           ...
           processed in a script, however, you may want to use _-_-_m_a_c_h_i_n_e_r_e_a_d_a_b_l_e instead.

       ----mmaacchhiinneerreeaaddaabbllee
           Print each match in a machine readable output format. The format is
           _r_e_p_o_s_i_t_o_r_y_\_0_p_k_g_n_a_m_e_\_0_p_k_g_v_e_r_\_0_p_a_t_h_\_n with _\_0 being the NULL character and _\_n a linefeed.

HHAANNDDLLIINNGG CCOONNFFIIGG FFIILLEESS
       Pacman uses the same logic as _r_p_m to determine action against files that are designated to be
       ...
       original=X, current=Y, new=Z
           All three files are different, so install the new file with a _._p_a_c_n_e_w extension and warn
       ...
       original=NULL, current=Y, new=Z
           ...
           Install the new file with a _._p_a_c_n_e_w extension and warn the user. The user must then
...
CCOONNFFIIGGUURRAATTIIOONN
       See ppaaccmmaann..ccoonnff(5) for more details on configuring pacman using the _p_a_c_m_a_n_._c_o_n_f file.
